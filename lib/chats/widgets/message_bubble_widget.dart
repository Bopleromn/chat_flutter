    ...
    child: Align(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(message.sentAt.hour.toString() + ':' + (message.sentAt.minute.toString().length == 1 ?  '0'  + message.sentAt.minute.toString()  : message.sentAt.minute.toString()), style: small_white(), textAlign: TextAlign.right,),
        ],
      ),
      ),
    ),
